...
screen = pygame.display.set_mode((WIDTH, HEIGHT)) # GUI 창을 설정
pygame.display.set_caption("Space Shooter") # 창이름 설정
...
def exit_menu():  #종료 화면 추가
    ...
    while True:                       
        ...
        if ev.type == pygame.KEYDOWN:    
            ...
            draw_text(screen, "THE END", 60, WIDTH/2, (HEIGHT/3)-30)
            draw_text(screen, "Press [ENTER] To Begin", 30, WIDTH/2, HEIGHT/2)
            draw_text(screen, "or [Q] To Quit", 30, WIDTH/2, (HEIGHT/2)+40)
            pygame.display.update()
...
while running:
    if score < 1000:
        ...
        if stage1:
            screen.fill(BLACK)
            draw_text(screen, "stage 2", 40, WIDTH/2, HEIGHT/2)
            pygame.display.update()
            pygame.time.wait(3000)
        ...
        if stage2:
            screen.fill(BLACK)
            draw_text(screen, "stage 3", 40, WIDTH/2, HEIGHT/2)
            pygame.display.update()
            pygame.time.wait(3000)
